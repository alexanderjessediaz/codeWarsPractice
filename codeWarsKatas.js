...
// SOLUTION
function dup(s) {
  const newStr = s.map(word => {
     return filterDuplicates(word)
  })
  return newStr
}
function filterDuplicates(word){
 const chars = word.split("")
   const words = chars.filter((char, i) => {
...
function paperSort(array) {
  return array.filter(trash => {
   if (
     trash.material === "paper" || trash.secondMaterial === "paper" 
     ) return true
 }).map(trash => {
   return trash.type
 })
...
function glassSort(array) {
  return array.filter(trash => {
   if (
     trash.material === "glass" || trash.secondMaterial === "glass" 
     ) return true
 }).map(trash => {
   return trash.type
 })
...
function organicSort(array) {
  return array.filter(trash => {
   if (
     trash.material === "organic" || trash.secondMaterial === "organic" 
     ) return true
 }).map(trash => {
   return trash.type
 })
...
function plasticSort(array) {
  return array.filter(trash => {
   if (
     trash.material === "plastic" || trash.secondMaterial === "plastic" 
     ) return true
 }).map(trash => {
   return trash.type
 })
...
function recycle(array){
  const recycledTrash = [paperSort(array),glassSort(array),organicSort(array),plasticSort(array)]
